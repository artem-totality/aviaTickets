...
class DropdownUI {
  ...
  addFavoriteTicket(ticket) {
    this.container.insertAdjacentHTML(
      "beforeend",
      DropdownUI.favoriteTicketTemplate(ticket)
    );
  }
...
const dropdownUI = new DropdownUI(getDropdownInstance);
